...
'---------------------------------------------------------'
#text
st.write("You can check about the Stocks")
...
st_date= st.text_input("Enter Starting date as YYYY-MM-DD", "2010-01-01")

'You Enterted the starting date: ', st_date

end_date= st.text_input("Enter Ending date as YYYY-MM-DD", "2020-01-01")
